...
- Reduced `AnalyticsListener` coverage now extends beyond the aggregate snapshot into forty-six
...
- full Java `AnalyticsListener` parity beyond the current reduced aggregate and forty-six concrete
...
| `AnalyticsListener` | Partial | aggregate analytics snapshot plus forty-six concrete reduced events and listener lifecycle coverage | remaining Java `AnalyticsListener` events plus richer payload parity for already-covered reduced events |
