...
| --- | --- | --- | --- | --- |
| `nativeObjectValueInfoParsingSmokeTest_parsesReducedValueTypes` | `objectValueParsing=1`; `stringString=hello|world`; `longLong=42`; `doubleDouble=2.500000`; `boolBool=1`; `nullType=0`; `otherString=object-value`; `invalidDoubleDouble=0.000000`; `truncatedType=0` | `DATA_STRUCTURE_MAPPING.md` `ObjectValueInfo`; `DATA_STRUCTURE_QUICK_REFERENCE.md` `ObjectValueInfo` row |  |  |
